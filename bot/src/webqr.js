...
function iniciarWebQR() {
  ...
  http.createServer(async (req, res) => {
    ...
    res.end(`${head}<meta http-equiv="refresh" content="20"><h2>${MARCA.nome} — parear o bot</h2><img src="${dataUrl}" alt="QR"><p>WhatsApp do bot → Aparelhos conectados → Conectar um aparelho</p><small>O código renova sozinho.</small>`);
