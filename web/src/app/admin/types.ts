...
export interface Cliente { id: number; nome: string; s: string; on: boolean; cal: number; desc: number; com: number; sup: string | null; af: number }
...
export interface ClienteRow {
  ...
  afiliado_id: number | null; afiliado_comissao_pct: number | string;
}
